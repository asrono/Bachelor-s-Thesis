%% Plots presentation
% creates plots for results section of presentation
...
r2 = [fliplr(-r) r];
h2 = [fliplr(h) h];
surf_fit = coef2surf(a_vec,r);
surf_fit2 = [fliplr(surf_fit) surf_fit];

%% Plots
figure(); hold on;
title('Surface and fit')
plot(r2,h2,'-k','linewidth',2)
plot(r2,surf_fit2,'-r','linewidth',1.5)
legend({'Surface','Zernike fit'},...
        'Interpreter','latex',...
        'Location', 'northwest'); 
grid on
xlabel('$r$');
